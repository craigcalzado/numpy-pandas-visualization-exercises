...
# Lowest hwy milage
comp.sort_values(by = ['hwy']).head(1)
# Highest hwy mileage
...
spc_perc = (spc_mean * 100).round(2)
print(spc_perc)

# f. 
bool_series = (mam.speed > mam.speed.median()) & (mam.hoppers == True)
fast_hoppers = mam[bool_series]
len(fast_hoppers)

round((len(fast_hoppers) / len(mam)) * 100, 2)